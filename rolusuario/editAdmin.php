    ...
    <div class="container">
        <div class="tabs mb-xl-5 mt-5">
            <ul class="nav nav-tabs">
                <div class="col-12">
                    <li class="nav-item">
                        <a class="nav-link active" href="#">Editar administrador</a>
                    </li>
                </div>
            </ul>
        </div>
        ...
        <div class="d-grid gap-2 col-6 mx-auto">
            <a class="link btn boton" href="tabladmin.php">Guardar</a>
            <a class="link btn btn-danger" href="tabladmin.php">Cancelar</a>
        </div>
    </div>
</body>
</html>