        ...
        <div class="container">
            <div class="tabs mb-xl-5 mt-5">
                <ul class="nav nav-tabs">
                    <div class="col-6">
                        <li class="nav-item ">
                            <a class="nav-link active" href="#">Lista de administradores</a>
                        </li>
                    </div>
                    <div class="col-6">
                        <li class="nav-item">
                            <a class="nav-link nActive" href="usuarioestudiante.php">Agregar administrador</a>
                        </li>
                    </div>
                </ul>
            </div>
            ...
            <form class="d-flex">
                <input class="form-control me-2" type="search" placeholder="Buscar un administrador" aria-label="Search">
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-grid gap-2 d-md-block">
                                <a href="editadmin.php" class="btn boton">Editar</a>
